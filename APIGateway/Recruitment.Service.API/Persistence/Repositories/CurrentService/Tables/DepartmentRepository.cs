...
{
	public class DepartmentRepository(HrisDbContext context) : IDepartmentRepository
	{
		...
		public async Task UpdateDepartment(int id, DepartmentRequestDto department)
		{
			...
			if (departmentInfo != null)
			{
				...
				departmentInfo.IndustryId = department.Industry;
				departmentInfo.Alias = department.Alias;
				departmentInfo.Website = department.Website;
				departmentInfo.TimezoneId = department.Timezone;
