...
public class UserDto
{
    ...
    public virtual ICollection<HRSolutionDbLibrary.Core.Entities.hris.Tables.Assessment> Assessments { get; set; } = new List<HRSolutionDbLibrary.Core.Entities.hris.Tables.Assessment>();
