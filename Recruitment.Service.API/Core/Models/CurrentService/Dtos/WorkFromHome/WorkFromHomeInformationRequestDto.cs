...
namespace Recruitment.Service.API.Core.Models.CurrentService.Dtos.WorkFromHome
{
	public class WorkFromHomeInformationRequestDto
	{
		...
		public List<OnboardingDocumentRequestDto>? OnboardingDocuDto { get; set; }
	}
}
