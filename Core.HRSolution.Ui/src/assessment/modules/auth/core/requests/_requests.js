...
export const GET_USER_BY_ACCESSTOKEN_URL = `${config.API_URL}/assessment/assessmentauth/verify_token`;
export const LOGIN_URL = `${config.API_URL}/assessment/assessmentauth/login`;
...
export function getCandidateByToken() {
...
// Server should return UserModel
export function getCandidateByTokenRevalidate(token) {
  return axios.get(GET_USER_BY_ACCESSTOKEN_URL, {
    token: token,
  });
}
