...
import { MenuItem, MenuLink, MenuTitle, MenuArrow, Menu } from '@/_metronic/components/menu';
import { MegaMenuSubProfiles, MegaMenuSubAccount, MegaMenuSubNetwork, MegaMenuSubAuth, MegaMenuSubHelp } from '@/_metronic/partials/menu/mega-menu';
import { useDemo1Layout } from '../Demo1LayoutProvider';
import { MENU_MEGA } from '@/app/config';
...
const MegaMenuInner = () => {
  ...
  const buildArrow = () => {
    return <MenuArrow className="flex lg:hidden text-gray-400">
  ...
  return <Menu multipleExpand={true} disabled={disabled} highlight={true} className="flex-col lg:flex-row gap-5 lg:gap-7.5 p-5 lg:p-0">
      {build(MENU_MEGA)}
    </Menu>;
};
