...
import { useMatchPath } from '@/_metronic/hooks';
const SidebarToggle = () => {
  const {
    layout,
    setSidebarCollapse
  ...
  const buttonBaseClass = clsx('btn btn-icon btn-icon-md size-[30px] rounded-lg border bg-light text-gray-500 hover:text-gray-700 toggle absolute start-full top-2/4 rtl:translate-x-2/4 -translate-x-2/4 -translate-y-2/4', layout.options.sidebar.collapse && 'active');
