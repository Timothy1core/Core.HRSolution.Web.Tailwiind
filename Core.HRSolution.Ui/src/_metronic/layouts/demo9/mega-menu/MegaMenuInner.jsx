...
import { MenuItem, MenuLink, MenuTitle, MenuArrow, Menu, KeenIcon } from '@/_metronic/components';
...
const MegaMenuInner = () => {
  ...
  return <Menu multipleExpand={true} highlight={true} className="flex-col lg:flex-row gap-5 lg:gap-7.5 p-5 lg:p-0">
      {build(MENU_MEGA)}
    </Menu>;
};
