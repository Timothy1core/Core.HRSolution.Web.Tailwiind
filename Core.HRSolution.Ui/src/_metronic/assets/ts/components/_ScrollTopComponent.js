...
class ScrollTopComponent {
  constructor(_element, options = defaultScrollTopOptions) {
  ...
  _scroll() {
    const offset = parseInt(this._getOption('offset'), 10);
  ...
  _go() {
    const speed = parseInt(this._getOption('speed'), 10);
  ...
  static createInstance(selector, options = defaultScrollTopOptions) {
