...
const btnClass =
  'btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-danger w-35px h-35px'
    ...
    <div className='app-navbar flex-shrink-0'>
      ...
      <div className={clsx('app-navbar-item', itemClass)}>
        <div
          ...
          className={btnClass +" pulse pulse-danger"}
        >
      ...
      {/* {config.app?.header?.default?.menu?.display && (
        <div className='app-navbar-item d-lg-none ms-2 me-n3' title='Show header menu'>
          <div
            className='btn btn-icon btn-active-color-danger w-35px h-35px'
