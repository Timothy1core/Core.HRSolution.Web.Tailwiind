...
const CompanyProfile = () => {
  ...
  const renderItem = (statistic, index) => {
    return <div key={index} className="flex flex-col gap-1.5 px-2.75 py-2.25 border border-dashed border-gray-400 rounded-md">
      ...
      <div className="card-body lg:py-7.5">
        <div className="flex flex-wrap gap-7.5">
          <div className="flex flex-col gap-3 items-center justify-center size-[140px] rounded-xl ring-1 ring-gray-200 bg-secondary-clarity">
            <img src={toAbsoluteUrl('/media/brand-logos/cloud-one.svg')} className="size-[70px]" alt="" />
