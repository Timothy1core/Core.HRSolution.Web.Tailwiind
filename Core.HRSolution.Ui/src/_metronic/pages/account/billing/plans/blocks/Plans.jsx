...
const Plans = () => {
  ...
  const renderPlanInfo = (type, info) => <Fragment>
      ...
      <div className="py-4">
        {info.free ? <h4 className="text-2xl text-gray-900 font-semibold leading-none">Free</h4> : <div className="flex items-end gap-1.5" data-plan-type={type}>
            <div className="text-2xl text-gray-900 font-semibold leading-none" data-plan-price-regular={info.price?.regular} data-plan-price-annual={info.price?.annual}>
          ...
          <tr>
            <td className="!border-b-0 align-bottom !p-5 !pt-7.5 !pb-6">
              <label className="switch switch-sm">
                <input className="order-1" type="checkbox" checked={isAnnual} onChange={handleToggleBilling} />
