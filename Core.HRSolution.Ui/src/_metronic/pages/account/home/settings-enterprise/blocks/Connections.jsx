...
import { DropdownCard2, DropdownCardItem1 } from '@/_metronic/partials/dropdowns/general';
const Connections = () => {
        ...
        <td className="py-3.5">
          <div className="flex items-center grow gap-2.5">
            ...
            <div className="flex flex-col gap-0.5">
              <a href="#" className="text-sm font-smedium text-gray-900 hover:text-primary-active mb-px">
                {table.name}
              </a>
