import { CardIntegration } from '@/_metronic/partials/cards';
const Integrations = () => {
  const items = [{
    logo: 'jira.svg',
  ...
  const renderItem = (item, index) => {
    return <CardIntegration logo={item.logo} path={item.path} name={item.name} description={item.description} actions={item.actions} key={index} />;
  };
