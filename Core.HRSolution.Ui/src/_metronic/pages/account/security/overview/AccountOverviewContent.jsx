...
import { MiscHighlightedPosts } from '@/_metronic/partials/misc';
import { FeaturesHighlight } from '@/_metronic/pages/public-profile/profiles/creator';
  ...
  return <div className="grid grid-cols-1 xl:grid-cols-3 gap-5 lg:gap-7.5">
      <div className="col-span-2">
        <div className="flex flex-col gap-5 lg:gap-7.5">
          <FeaturesHighlight image={<Fragment>
      ...
      <div className="col-span-1">
        <div className="flex flex-col gap-5 lg:gap-7.5">
          <ProductInsight image={<Fragment>
              ...
              </Fragment>} title="iOS" description="Active Sessions" number={24} />

          <ProductInsight image={<img src={toAbsoluteUrl('/media/brand-logos/android.svg')} className="h-5" alt="" />} title="Android" description="Active Sessions" number={35} />
