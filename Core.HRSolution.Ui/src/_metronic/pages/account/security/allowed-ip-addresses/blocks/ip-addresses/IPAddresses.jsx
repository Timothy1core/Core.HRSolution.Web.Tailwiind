...
import { DataGrid, DataGridColumnHeader, DataGridColumnVisibility, DataGridRowSelect, DataGridRowSelectAll, DefaultTooltip, KeenIcon, useDataGrid } from '@/_metronic/components';
...
const IPAddresses = () => {
  ...
  const columns = useMemo(() => [{
    ...
    header: ({
      column
    }) => <DataGridColumnHeader title="IP Address" filter={<ColumnInputFilter column={column} />} column={column} />,
    enableSorting: true,
