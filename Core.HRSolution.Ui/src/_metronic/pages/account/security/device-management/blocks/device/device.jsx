...
import { DataGrid, DataGridColumnHeader, DataGridColumnVisibility, DataGridRowSelect, DataGridRowSelectAll, KeenIcon, useDataGrid, DefaultTooltip } from '@/_metronic/components';
...
const Device = () => {
  ...
  const columns = useMemo(() => [{
    ...
    header: ({
      column
    }) => <DataGridColumnHeader title="Device" filter={<ColumnInputFilter column={column} />} column={column} />,
    enableSorting: true,
    cell: ({
      row
    }) => {
