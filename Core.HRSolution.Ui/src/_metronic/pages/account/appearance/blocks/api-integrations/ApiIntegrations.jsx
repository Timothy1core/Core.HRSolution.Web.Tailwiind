...
import { DataGrid, DataGridColumnHeader, DataGridColumnVisibility, DataGridRowSelect, DataGridRowSelectAll, KeenIcon, useDataGrid } from '@/_metronic/components';
import { toast } from 'sonner';
import { Input } from '@/_metronic/components/ui/input';
import { CrudCardFooter } from '@/_metronic/partials/crud';
...
const ApiIntegrations = () => {
  ...
  return <>
      <DataGrid columns={columns} data={data} rowSelection={true} onRowSelectionChange={handleRowSelection} pagination={{
      size: 10
    }} sorting={[{
      id: 'integration',
      desc: false
