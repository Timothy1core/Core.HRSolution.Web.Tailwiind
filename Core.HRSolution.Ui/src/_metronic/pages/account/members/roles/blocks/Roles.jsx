...
import { CardAddNew, CardRole } from '@/_metronic/partials/cards';
const Roles = () => {
  const items = [{
    badge: {
      size: 'size-[44px]',
  ...
  return <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-7.5">
      ...
      <CardAddNew path="/public-profile/works" size="size-[60px]" iconSize="text-2xl" title="Add New Role" subTitle="Ignite Professional Adventures" />
    </div>;
};
export { Roles };