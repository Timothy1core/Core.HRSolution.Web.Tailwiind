...
import { DataGrid, DataGridColumnHeader, DataGridColumnVisibility, DataGridRowSelect, DataGridRowSelectAll, KeenIcon, useDataGrid, Menu, MenuItem, MenuToggle } from '@/_metronic/components';
...
const Members = () => {
  ...
  const columns = useMemo(() => [{
    ...
    enableSorting: true,
    cell: info => <span className={`badge badge-pill badge-outline ${info.row.original.status.variant} gap-1 items-center`}>
