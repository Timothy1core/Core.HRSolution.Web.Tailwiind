...
const Post1 = () => {
  ...
  return <div className="card">
      <Heading author="Jenny Klabber" avatar={{
      image: '300-1.png',
      ...
      <div className="grid gap-5 mb-5 px-7.5">
        ...
        <div className="grid grid-cols-2 gap-2.5 xl:gap-7.5">
          <div>
            <div className="bg-cover bg-no-repeat min-h-[340px] w-full rounded-xl" style={{
          ...
          <div className="grid grid-rows-2 gap-2.5 xl:gap-7.5">
            <div>
              <div className="bg-cover bg-no-repeat rounded-xl h-full w-full" style={{
      ...
      <div>
        <Tabs postId={1} activeTab={activeTab} setActiveTab={setActiveTab} comments={2} likes="47k" saves={900} className="mx-7.5" />

        {activeTab === 'comments' && <div id="post_1_comments">
            <Comments items={comments} />
          </div>}
        {activeTab === 'likes' && <div id="post_1_likes">
            <Likes />
          </div>}
        {activeTab === 'saves' && <div id="post_1_saves">
            <Saves />
          </div>}
      </div>
    </div>;
