    ...
    return <React.Fragment key={index}>
        <div className="flex flex-col md:flex-row md:items-center gap-5">
          <div className="flex items-center gap-5 shrink-0">
            ...
            <img src={toAbsoluteUrl(`/media/images/600x400/${item.image}`)} className="rounded-lg max-h-[120px] max-w-full" alt="" />
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <a href="#" className="text-base font-medium hover:text-primary text-gray-900 leading-4">
              {item.title}
            </a>
