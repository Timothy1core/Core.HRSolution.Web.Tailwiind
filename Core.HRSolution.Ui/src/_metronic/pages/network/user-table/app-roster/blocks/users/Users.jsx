...
import { DataGrid, KeenIcon, DataGridColumnHeader, DataGridRowSelect, DataGridRowSelectAll, useDataGrid } from '@/_metronic/components';
...
const Users = () => {
  ...
  const columns = useMemo(() => [{
    ...
    header: ({
      column
    }) => <DataGridColumnHeader title="Users" filter={<ColumnInputFilter column={column} />} column={column} />,
    enableSorting: true,
    cell: ({
      row
    }) => {
