...
const DropdownNotificationsItem9 = () => {
  ...
  return <div className="flex grow gap-2.5 px-5">
      <div className="relative shrink-0 mt-0.5">
        <img src={toAbsoluteUrl(`/media/avatars/300-1.png`)} className="rounded-full size-8" alt="" />
      ...
      <div className="flex flex-col gap-2.5 grow">
        ...
        <div className="flex items-center gap-2.5">
          {items.map(item => <div className="card shadow-none flex flex-col gap-3.5 bg-light-active w-40" key={item.id}>
              <div className="bg-cover bg-no-repeat card-rounded-t shrink-0 h-24" style={{
