...
const DropdownNotificationsItem7 = () => {
  return <div className="flex grow gap-2 px-5">
      <div className="relative shrink-0 mt-0.5">
        <img src={toAbsoluteUrl('/media/avatars/300-15.png')} className="rounded-full size-8" alt="Nova Hawthorne avatar" />
          ...
          <div className="flex items-center justify-between flex-wrap gap-2.5">
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex flex-col gap-1.5">
                <Link to="#" className="hover:text-primary-active text-gray-700 font-medium text-xs me-1">
            ...
            <CommonAvatars size="size-6" group={[{
