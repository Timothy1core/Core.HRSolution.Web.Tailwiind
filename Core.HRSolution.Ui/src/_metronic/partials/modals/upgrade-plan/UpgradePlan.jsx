...
const plans = [
  {
    ...
    custom: false,
    features: [
      { title: 'Up to 10 Active Users', supported: true },
      { title: 'Up to 30 Project Integrations', supported: true },
      { title: 'Analytics Module', supported: true },
      { title: 'Finance Module', supported: false },
      { title: 'Accounting Module', supported: false },
      { title: 'Network Platform', supported: false },
      { title: 'Unlimited Cloud Space', supported: false },
    ],
  },
  {
    title: 'Advanced',
    ...
    features: [
      ...
      { title: 'Up to 30 Project Integrations', supported: true },
      { title: 'Analytics Module', supported: true },
      { title: 'Finance Module', supported: true },
      { title: 'Accounting Module', supported: true },
      { title: 'Network Platform', supported: false },
      { title: 'Unlimited Cloud Space', supported: false },
    ],
  },
  {
    ...
    features: [
      ...
      { title: 'Finance Module', supported: true },
      { title: 'Accounting Module', supported: true },
      { title: 'Network Platform', supported: true },
      { title: 'Unlimited Cloud Space', supported: true },
    ],
  },
  {
    title: 'Custom',
          ...
          <div className='modal-body pt-0 pb-15 px-5 px-xl-20'>
            ...
            <div className='d-flex flex-column'>
              <div className='nav-group nav-group-outline mx-auto' data-kt-buttons='true'>
                <a
                  href='#'
                  className={`btn btn-color-gray-500 btn-active btn-active-secondary px-6 py-3 me-2 ${
                    currentState === 'month' ? 'active' : ''
                  }`}
                  onClick={() => setCurrentState('month')}
                  data-kt-plan='month'
                >
                  Monthly
                </a>
                <a
                  ...
                  onClick={() => setCurrentState('annual')}
                  data-kt-plan='annual'
                >
                  Annual
                </a>
                  ...
                  <div className='nav flex-column'>
                    {plans.map((plan, index) => (
                      <div
                        ...
                        } ${plan.default ? 'active' : ''} ${!plan.custom ? 'btn-active btn-active-primary' : ''}`}
                        data-bs-toggle='tab'
                    ...
                    {plans.map((plan, index) => (
                      <div key={`custom${index}`}>
                        {plan.title === selected && !plan.custom && (
                          ...
                          >
                            <div className='pb-5'>
                              <h2 className='fw-bolder text-gray-900'>What’s in {plan.title} Plan?</h2>
