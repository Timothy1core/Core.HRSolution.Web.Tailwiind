...
import { NavbarDropdown } from '@/_metronic/partials/navbar';
import { Dialog, DialogBody, DialogContent, DialogDescription, DialogHeader, DialogTitle } from '@/_metronic/components/ui/dialog';
import { About, CommunityBadges, Connections, Contributions, Projects, WorkExperience } from '@/_metronic/pages/public-profile/profiles/default';
const ModalProfile = ({
  open,
  onOpenChange
}) => {
              ...
              <div className="grid lg:grid-cols-3 gap-3 w-full items-center">
                ...
                <div className="flex items-center flex-col">
                  <div className="flex items-center gap-1.5 mb-2">
                    <a href="#" className="text-lg leading-5 font-semibold text-gray-800 hover:text-primary">
                      Jenny Klabbe
                    </a>
                  ...
                  <div className="flex flex-wrap justify-center gap-1 lg:gap-3 text-sm">
                    <div className="flex gap-1 items-center">
                      ...
                      <a href="https://keenthemes.com" className="text-gray-600 hover:text-primary" rel="noopener noreferrer">
                        Keenthemes
                      </a>
                    </div>
                    <div className="flex gap-1 items-center">
