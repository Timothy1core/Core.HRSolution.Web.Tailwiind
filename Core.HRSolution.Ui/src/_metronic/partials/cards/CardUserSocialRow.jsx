  ...
  return <div className="card p-7.5">
      <div className="flex items-center flex-wrap justify-between gap-5">
        <div className="flex items-center gap-3.5">
          <CommonAvatar className={avatar?.className} image={avatar?.image} imageClass={avatar?.imageClass} badgeClass={avatar?.badgeClass} fallback={avatar?.fallback} />
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-1.5 mb-px">
              ...
              {verify && <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" fill="none" className="text-primary">
