...
const CardConnectionRow = ({
  ...
  const renderItem = (statistic, index) => {
    return <div key={index} className="grid grid-cols-1 gap-1.5 border-[0.5px] border-dashed border-gray-400 shrink-0 rounded-md px-2.5 py-2">
      ...
      <div className="flex items-center flex-wrap justify-between gap-5">
        <div className="flex items-center gap-3.5">
          <div className="flex justify-center">
            {avatar && <CommonAvatar image={avatar.image} fallback={avatar.fallback} badgeClass={avatar.badgeClass} className={avatar.className} imageClass={avatar.imageClass} />}
          </div>

          <div className="grid">
            <div className="flex items-center gap-1.5 mb-2.5">
              <a href="#" className="text-base leading-5 font-medium hover:text-primary-active text-gray-900">
                {name}
              </a>

              <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" fill="none" className="text-primary">
        ...
        <div className="flex items-center flex-wrap gap-5 lg:gap-11">
          ...
          <div className="text-end w-28">
            {connected ? <a className="btn btn-light btn-sm">
