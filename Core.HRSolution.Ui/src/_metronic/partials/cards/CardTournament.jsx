...
const CardTournament = ({
  ...
  const renderItem = (label, index) => {
    return <span key={index} className="badge badge-sm badge-outline">
        {label}
      </span>;
  };
  return <div className="card shadow-none w-[285px] border-0">
      <div className="bg-cover bg-center bg-no-repeat rounded-t-xl h-56 w-[285px]" style={{
      ...
      <div className="card-border card-rounded-b grid gap-6 px-5 pt-3.5 pb-3 mb-4">
        <div className="flex items-center gap-2.5">
          ...
          <div className="grid grid-cols-1 gap-0.5">
            <a href="#" className="text-gray-900 hover:text-primary-active text-md font-medium mb-px">
              {title}
            </a>
