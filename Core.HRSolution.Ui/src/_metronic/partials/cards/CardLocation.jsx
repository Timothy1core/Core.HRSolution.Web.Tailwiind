...
const CardLocation = ({
  ...
  return <div className="card shadow-none w-[280px] border-0 mb-4">
      <img src={toAbsoluteUrl(`/media/images/600x400/${image}`)} className="rounded-t-xl max-w-[280px] shrink-0" alt="" />
