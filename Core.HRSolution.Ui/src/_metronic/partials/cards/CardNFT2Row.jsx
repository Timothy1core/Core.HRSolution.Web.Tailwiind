...
const CardNFT2Row = ({
  ...
  const renderItem = (statistic, index) => {
    return <div key={index} className="grid grid-cols-1 gap-1.5 border border-dashed border-gray-300 shrink-0 rounded-md min-w-24 max-w-auto px-2.5 py-2">
  ...
  return <div className="card p-7.5">
      <div className="flex items-center flex-wrap justify-between gap-5">
        <div className="flex items-center gap-3.5">
          <CommonAvatar className={avatar?.className} fallback={avatar?.fallback} image={avatar?.image} imageClass={avatar?.imageClass} badgeClass={avatar?.badgeClass} />
