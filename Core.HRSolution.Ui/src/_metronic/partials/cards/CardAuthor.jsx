...
const CardAuthor = ({
  ...
  return <div className="card">
      <div className="card-header p-0 bg-no-repeat bg-cover bg-center card-rounded-t h-40" style={{
      ...
      <div className="card-body mb-7.5 p-0">
        <div className="flex transform -translate-y-1/2 px-5 lg:px-7.5 gap-1.5">
          <CommonAvatar className={avatar?.className} image={avatar?.image} imageClass={avatar?.imageClass} badgeClass={avatar?.badgeClass} />
