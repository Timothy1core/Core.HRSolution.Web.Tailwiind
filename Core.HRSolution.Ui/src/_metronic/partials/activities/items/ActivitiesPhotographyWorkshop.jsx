          ...
          <div className="grid gap-4">
            <div className="flex flex-col md:flex-row md:items-center gap-5">
              ...
              <div className="flex flex-col gap-2">
                <a href="#" className="text-xs text-brand leading-[14px] hover:text-primary-active mb-px">
                  Photo Workshop
                </a>
                <a href="#" className="text-md font-medium hover:text-primary text-gray-900 leading-4">
