    ...
    >
      ...
      >
        {messages.map((message, index) => {
          ...
          const state = message.type === 'in' ? 'info' : 'danger';
          const templateAttr = {};
          if (message.template) {
                  ...
                  {message.type === 'in' ? (
                    <>
                      ...
                      <div className='ms-3'>
                        <a
                          href='#'
                          className='fs-5 fw-bolder text-gray-900 text-hover-danger me-1'
                        >
                          {userInfo.name}
                        </a>
                    ...
                    <>
                      <div className='me-3'>
                        ...
                        <a
                          href='#'
                          className='fs-5 fw-bolder text-gray-900 text-hover-danger ms-1'
                        >
                          You
                        </a>
                      </div>
