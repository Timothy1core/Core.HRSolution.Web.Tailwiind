...
const DropdownMenuSubTrigger = React.forwardRef(({
  ...
  children,
  ...props
}, ref) => <DropdownMenuPrimitive.SubTrigger ref={ref} className={cn('flex cursor-default gap-2 select-none items-center rounded-md px-2 py-1.5 text-sm outline-none focus:bg-accent data-[state=open]:bg-accent [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0', inset && 'pl-8', className)} {...props}>
    {children}
...
const DropdownMenuCheckboxItem = React.forwardRef(({
  ...
  ...props
    ...
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center text-muted-foreground justify-center">
