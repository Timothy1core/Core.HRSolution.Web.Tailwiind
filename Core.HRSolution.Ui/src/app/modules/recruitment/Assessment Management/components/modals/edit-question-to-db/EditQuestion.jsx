    ...
    const handleModalShown = () => {
      ...
      if (selectedQuestion) {
        formik.setValues({
          ...
          videoDurationId: selectedQuestion.assessmentVideoDurations?.[0]?.id || null,
          videoDuration: selectedQuestion.assessmentVideoDurations?.[0]?.videoDurationMinute || 0,
        });
  
        if (selectedQuestion.assessmentChoices) {
          setChoices(
            selectedQuestion.assessmentChoices.map((choice) => ({
          ...
          <div className="modal-body mx-5 mx-xl-18 pt-0 pb-5">
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className="fv-row my-10 w-50">
                ...
                />
                  <span className="form-control form-control-solid text-end">minute/s</span>
                </div>
