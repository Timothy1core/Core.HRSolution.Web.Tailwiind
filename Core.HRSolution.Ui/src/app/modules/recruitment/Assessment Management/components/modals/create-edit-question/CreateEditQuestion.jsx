...
const CreateEditQuestion = ({ onCreateQuestion, selectedQuestion, questions, isCreating, clearSelectedQuestion }) => {
  ...
  const handleHideModal = () => {
    clearSelectedQuestion?.(); // <-- Call to reset the selected question
    formik.resetForm();
    setCreating(true);
