module.exports = {
  ...
  plugins: [
    ...
    require('./src/_metronic/plugins/plugin'),
    require('./src/_metronic/plugins/components/theme'),
    require('./src/_metronic/plugins/components/breakpoints'),
    require('./src/_metronic/plugins/components/typography'),
    require('./src/_metronic/plugins/components/menu'),
    require('./src/_metronic/plugins/components/dropdown'),
    require('./src/_metronic/plugins/components/accordion'),
    require('./src/_metronic/plugins/components/input'),
    require('./src/_metronic/plugins/components/input-group'),
    require('./src/_metronic/plugins/components/select'),
    require('./src/_metronic/plugins/components/textarea'),
    require('./src/_metronic/plugins/components/file-input'),
    require('./src/_metronic/plugins/components/switch'),
    require('./src/_metronic/plugins/components/checkbox'),
    require('./src/_metronic/plugins/components/radio'),
    require('./src/_metronic/plugins/components/range'),
    require('./src/_metronic/plugins/components/container'),
    require('./src/_metronic/plugins/components/image-input'),
    require('./src/_metronic/plugins/components/modal'),
    require('./src/_metronic/plugins/components/drawer'),
    require('./src/_metronic/plugins/components/tooltip'),
    require('./src/_metronic/plugins/components/popover'),
    require('./src/_metronic/plugins/components/btn'),
    require('./src/_metronic/plugins/components/btn-group'),
    require('./src/_metronic/plugins/components/tabs'),
    require('./src/_metronic/plugins/components/pagination'),
    require('./src/_metronic/plugins/components/card'),
    require('./src/_metronic/plugins/components/table'),
    require('./src/_metronic/plugins/components/badge'),
    require('./src/_metronic/plugins/components/rating'),
    require('./src/_metronic/plugins/components/scrollable'),
    require('./src/_metronic/plugins/components/progress'),
    require('./src/_metronic/plugins/components/apexcharts'),
    require('./src/_metronic/plugins/components/leaflet')
  ]
};
