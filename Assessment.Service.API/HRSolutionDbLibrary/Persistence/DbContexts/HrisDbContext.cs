...
{
	public class HrisDbContext(DbContextOptions<HrisDbContext> options) : DbContext(options), IHrisDbContext
	{
		...
		public DbSet<DepartmentIndustry> DepartmentIndustries { get; set; }
		public DbSet<DepartmentTimeZone> DepartmentTimeZones { get; set; }
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.ApplyConfiguration(new DepartmentTeamConfig());
			modelBuilder.ApplyConfiguration(new DepartmentIndustryConfig());
			modelBuilder.ApplyConfiguration(new DepartmentTimeZoneConfig());
			modelBuilder.ApplyConfiguration(new DepartmentTeamConfig());
