...
const JobOfferModal = ({ show, handleClose,handleCloseWithRefresh, jobOfferId }) => {
  const [loading, setLoading] = useState(false);
  const [listApprovers, setListApprovers] = useState([]);
  const [listStatuses, setStatusDropdown] = useState([]);
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting, setStatus }) => {
      ...
      try {
        ...
        formData.append('JobOfferStatusId', values.jobOfferStatusId);
      ...
      try {
        ...
        if (res.status === 200 && res.data) {
          formik.setValues({
            ...
            jobOfferStatusId: parseInt(res.data.jobOfferInfo.jobOfferStatusId) || ''
          });
          setCandidate(res.data.jobOfferInfo)
          setCandidateId(res.data.jobOfferInfo.candidateId)
          setStatusDropdown(res.data.statusList)
        }
      } catch (error) {
    ...
    <Modal className='modal-sticky modal-lg' show={show} onHide={handleClose} animation={false}>
      <div className='modal-content'>
        <div className='d-flex align-items-center justify-content-between py-5 px-8 border-bottom'>
          <h5 className='fw-bold m-0'>Job Offer Data</h5>
            ...
            <div className="card-body">
              ...
              <div className="row my-2">
                ...
                <div className="col-md-6">
                  ...
                  <select {...formik.getFieldProps('jobOfferStatusId')} className="form-control">
                    <option value="" hidden>Select Application Status</option>
