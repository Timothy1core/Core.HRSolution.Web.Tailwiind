...
export const  GET_DEPARTMENT_DASHBOARD_URL = `${config.API_URL}/recruitment/department/retrieve_dashboard_department`;
export const  POST_CREATE_COMPANY_PROFILE_URL = `${config.API_URL}/recruitment/department/create_department`;
export const  GET_DEPARTMENT_PROFILE_URL = `${config.API_URL}/recruitment/department/retrieve_department_profile`;
export const  PUT_UPDATE_DEPARTMENT_PROFILE_URL = `${config.API_URL}/recruitment/department/update_department`;
...
export const  GET_DEPARTMENT_LOGO_URL = `${config.API_URL}/recruitment/department/department_logo`;
export const  GET_CORE_SERVICE_DROPDOWN_URL = `${config.API_URL}/recruitment/department/core_services_dropdown_list`;
export const  GET_DEPARTMENT_STATUS_DROPDOWN_URL = `${config.API_URL}/recruitment/department/department_status_dropdown_list`;
...
export const  GET_DEPARTMENT_GROUP_DROPDOWN_URL = `${config.API_URL}/recruitment/department/department_group_list`;
...
export function SelectCompanyDashboard(groupId,serviceId, statusId) {
  ...
  return axios.get(GET_DEPARTMENT_DASHBOARD_URL, { params })  // Pass params as an object
}
...
export function SelectCompanyProfileInformation(id) {
  return axios.get(`${GET_DEPARTMENT_PROFILE_URL}/${id}`);
}

export function UpdateCompanyProfile(id,formData) {
  return axios.put(`${PUT_UPDATE_DEPARTMENT_PROFILE_URL}/${id}`,formData);
}
...
export function SelectClientStatusDropDown() {
  return axios.get(GET_DEPARTMENT_STATUS_DROPDOWN_URL);
}
...
export function SelectClientCompanyGroupDropDown() {
  return axios.get(`${GET_DEPARTMENT_GROUP_DROPDOWN_URL}`);
}
