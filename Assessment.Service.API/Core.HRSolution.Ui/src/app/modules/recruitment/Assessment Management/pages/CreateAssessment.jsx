  ...
  <>
    ...
    <form onSubmit={formik.handleSubmit}>
      ...
      <div className='mb-5 mb-xl-8 px-2 py-0 '>
        ...
        <div className="row">
            <div className="col-4 border border-dark border-right-0 py-2">
            ...
            <label className='form-label required mt-5'>Duration</label>
                ...
                <input
                  ...
                  <div className="input-group-append">
                    <span className="input-group-text" id="basic-addon2">minute/s</span>
                  </div>
                </div>
            ...
            <div className="col-8 border border-dark py-2">
    ...
    {/* </div> */}
        ...
        <CreateEditQuestion
          ...
          questions={questions}
          clearSelectedQuestion={handleClearSelectedQuestion}
        />
