      ...
      <div className='tab-pane fade' id='kt_topbar_notifications_1' role='tabpanel'>
            ...
            <div key={`alert${index}`} className='d-flex flex-stack py-4'>
              <div className='d-flex align-items-center'>
                ...
                <div className='mb-0 me-2'>
                  <a href='#' className='fs-6 text-gray-800 text-hover-danger fw-bolder'>
                    {alert.title}
                  </a>
        ...
        <div className='py-3 text-center border-top'>
          <Link
            ...
            className='btn btn-color-gray-600 btn-active-color-danger'
          >
        ...
        <div className='d-flex flex-column px-9'>
          <div className='pt-10 pb-0'>
            ...
            <div className='text-center mt-5 mb-9'>
              <a
                href='#'
                className='btn btn-sm btn-danger px-6'
          ...
          {defaultLogs.map((log, index) => (
            <div key={`log${index}`} className='d-flex flex-stack py-4'>
              <div className='d-flex align-items-center me-2'>
                ...
                <a href='#' className='text-gray-800 text-hover-danger fw-bold'>
                  {log.message}
                </a>
