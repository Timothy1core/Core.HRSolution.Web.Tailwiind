...
{
	public class UoWForCurrentService(HrisDbContext context) : IUoWForCurrentService
	{
		...
		public IDepartmentIndustryRepository DepartmentIndustryRepository { get; } = new DepartmentIndustryRepository(context);
		public IDepartmentTimeZoneRepository DepartmentTimeZoneRepository { get; } = new DepartmentTimeZoneRepository(context);
